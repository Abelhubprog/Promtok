...
PROMTOK uses a flexible environment configuration system that supports various deployment scenarios:
...
PROMTOK uses several AI models that are automatically downloaded on first use:
